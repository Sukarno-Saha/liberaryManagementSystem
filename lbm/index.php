...
<body>
    ...
    <section id="footer-part">
            <footer class="footer">
                <div class="row">
                <div class="col">
                        <center><h3>LINKS <div class="underline"><span></span></div></h3></center>
                        <li ><a href="">HOME</a></li>
                        <li><a href="">BOOKS</a></li>
                        <li><a href="">CONTACT US</a></li>
                    </div>
                    <div class="col">
                        <center><h3>ADDRESS <div class="underline"><span></span></div></h3></center>
                        ...
                        <p class="email-id">library@gmail.com</p>
                        <h5 class="phone_no">+91-9709709701</h5>
                    </div>
                    <div class="col">
                        <center><h3>SOCIALS <div class="underline"><span></span></div></h3></center>
